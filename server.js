...
const CUSTOM_PROMPTS = {
  ...
  'partition-mode': {
    ...
    description: 'Generates more intense intimate scenes by adding a detailed list of guidelines to follow',
  ...
  'nsfw-rules': {
    ...
    description: 'Adds a set of NSFW rules intended to improve intimate, sexual scenes',
